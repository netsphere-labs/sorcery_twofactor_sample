...
<img src="01_new_user.png" width="800" />
<img src="02_login_screen.png" width="800" /> 
<img src="03_google_qr_code.png" width="800" /> 1要素目の認証が成功したので、QRコードで登録を促す. 当然, 2回目以降はQRコードを表示しない (してはならない)。
<img src="04_succeeded.png" width="800" />
